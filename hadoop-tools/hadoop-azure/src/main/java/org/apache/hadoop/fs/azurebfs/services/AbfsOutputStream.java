...
public class AbfsOutputStream extends OutputStream implements Syncable {
  ...
  private final String STREAM_CAPABILITIES_HFLUSH = "hflush";
  private final String STREAM_CAPABILITIES_HSYNC = "hsync";
  ...
  public boolean hasCapability(String capability) {
    switch (capability.toLowerCase(Locale.ENGLISH)) {
      case STREAM_CAPABILITIES_HSYNC:
      case STREAM_CAPABILITIES_HFLUSH:
        return supportFlush;
      default:
        return false;
    }
